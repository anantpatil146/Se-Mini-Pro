...
def load_or_create_embeddings(pdf_path):
    ...
    try:
        ...
        console.print(f"[bold red]Error in load_or_create_embeddings: {str(e)}[/bold red]")
        raise
...
def setup_qa_chain(vector):
    """Set up the question-answering chain with the given vector store.
    
    Args:
        vector: FAISS vector store containing document embeddings
        
    Returns:
        RetrievalQA: Configured QA chain for document retrieval and answering
    """
